...
public class AgenParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AgenGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCodeBlockAccess().getGroup_1_3(), "rule__CodeBlock__Group_1_3__0");
			...
			builder.put(grammarAccess.getWhenAccess().getGroup_6(), "rule__When__Group_6__0");
			...
			builder.put(grammarAccess.getRandomBetweenRoundAccess().getGroup(), "rule__RandomBetweenRound__Group__0");
			...
			builder.put(grammarAccess.getConditionAccess().getGroup_1_3(), "rule__Condition__Group_1_3__0");
			...
			builder.put(grammarAccess.getRunConfigurationAccess().getCoordinatorLocationAssignment_4(), "rule__RunConfiguration__CoordinatorLocationAssignment_4");
			builder.put(grammarAccess.getRunConfigurationAccess().getNodesAssignment_6(), "rule__RunConfiguration__NodesAssignment_6");
			...
			builder.put(grammarAccess.getSyncpointAccess().getFaultCondAssignment_15(), "rule__Syncpoint__FaultCondAssignment_15");
			...
			builder.put(grammarAccess.getCodeBlockAccess().getImportsAssignment_1_3_2(), "rule__CodeBlock__ImportsAssignment_1_3_2");
			builder.put(grammarAccess.getCodeBlockAccess().getCodeAssignment_1_4(), "rule__CodeBlock__CodeAssignment_1_4");
			...
			builder.put(grammarAccess.getWhenAccess().getRandomBetweenRoundAssignment_3(), "rule__When__RandomBetweenRoundAssignment_3");
			builder.put(grammarAccess.getWhenAccess().getIfConditionAssignment_4_2(), "rule__When__IfConditionAssignment_4_2");
			builder.put(grammarAccess.getWhenAccess().getFaultCondAssignment_5(), "rule__When__FaultCondAssignment_5");
			builder.put(grammarAccess.getWhenAccess().getSyncpointAssignment_6_2(), "rule__When__SyncpointAssignment_6_2");
			...
			builder.put(grammarAccess.getRandomBetweenRoundAccess().getStartAssignment_2(), "rule__RandomBetweenRound__StartAssignment_2");
			builder.put(grammarAccess.getRandomBetweenRoundAccess().getEndAssignment_4(), "rule__RandomBetweenRound__EndAssignment_4");
			builder.put(grammarAccess.getRandomBetweenRoundAccess().getIntervalAssignment_6(), "rule__RandomBetweenRound__IntervalAssignment_6");
			builder.put(grammarAccess.getRandomBetweenRoundAccess().getChanceAssignment_8(), "rule__RandomBetweenRound__ChanceAssignment_8");
			...
			builder.put(grammarAccess.getConditionAccess().getImportsAssignment_1_3_2(), "rule__Condition__ImportsAssignment_1_3_2");
			builder.put(grammarAccess.getConditionAccess().getCodeAssignment_1_4(), "rule__Condition__CodeAssignment_1_4");
