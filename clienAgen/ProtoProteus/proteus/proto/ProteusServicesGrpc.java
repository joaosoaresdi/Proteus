...
public class ProteusServicesGrpc {
  ...
  public static final io.grpc.MethodDescriptor<proteus.proto.ProtoRuntime.ConnectionRequest,
      proteus.proto.ProtoRuntime.ConnectionReply> METHOD_FIRST_CONNECTION =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ProteusServices", "FirstConnection"),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.ConnectionRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.ConnectionReply.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<proteus.proto.ProtoRuntime.Log,
      proteus.proto.ProtoRuntime.ConnectionReply> METHOD_LOGGING =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ProteusServices", "Logging"),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.Log.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.ConnectionReply.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<proteus.proto.ProtoRuntime.StatusQuestion,
      proteus.proto.ProtoRuntime.ConnectionReply> METHOD_SYNC_POINT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ProteusServices", "SyncPoint"),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.StatusQuestion.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(proteus.proto.ProtoRuntime.ConnectionReply.getDefaultInstance()));
  ...
  public static abstract class ProteusServicesImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void firstConnection(proteus.proto.ProtoRuntime.ConnectionRequest request,
        io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_FIRST_CONNECTION, responseObserver);
    }

    /**
     */
    public void logging(proteus.proto.ProtoRuntime.Log request,
        io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply> responseObserver) {
    ...
    /**
     */
    public void syncPoint(proteus.proto.ProtoRuntime.StatusQuestion request,
        io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proteus.proto.ProtoRuntime.ConnectionRequest,
                proteus.proto.ProtoRuntime.ConnectionReply>(
                  this, METHODID_FIRST_CONNECTION)))
          .addMethod(
            METHOD_LOGGING,
            asyncUnaryCall(
              new MethodHandlers<
                proteus.proto.ProtoRuntime.Log,
                proteus.proto.ProtoRuntime.ConnectionReply>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                proteus.proto.ProtoRuntime.StatusQuestion,
                proteus.proto.ProtoRuntime.ConnectionReply>(
  ...
  public static final class ProteusServicesBlockingStub extends io.grpc.stub.AbstractStub<ProteusServicesBlockingStub> {
    ...
    /**
     */
    public proteus.proto.ProtoRuntime.ConnectionReply firstConnection(proteus.proto.ProtoRuntime.ConnectionRequest request) {
    ...
    /**
     */
    public proteus.proto.ProtoRuntime.ConnectionReply logging(proteus.proto.ProtoRuntime.Log request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public proteus.proto.ProtoRuntime.ConnectionReply syncPoint(proteus.proto.ProtoRuntime.StatusQuestion request) {
      return blockingUnaryCall(
  ...
  public static final class ProteusServicesFutureStub extends io.grpc.stub.AbstractStub<ProteusServicesFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proteus.proto.ProtoRuntime.ConnectionReply> firstConnection(
        proteus.proto.ProtoRuntime.ConnectionRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proteus.proto.ProtoRuntime.ConnectionReply> logging(
        proteus.proto.ProtoRuntime.Log request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proteus.proto.ProtoRuntime.ConnectionReply> syncPoint(
        proteus.proto.ProtoRuntime.StatusQuestion request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIRST_CONNECTION:
          serviceImpl.firstConnection((proteus.proto.ProtoRuntime.ConnectionRequest) request,
              (io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply>) responseObserver);
          break;
        case METHODID_LOGGING:
          serviceImpl.logging((proteus.proto.ProtoRuntime.Log) request,
              (io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply>) responseObserver);
          break;
        case METHODID_SYNC_POINT:
          serviceImpl.syncPoint((proteus.proto.ProtoRuntime.StatusQuestion) request,
              (io.grpc.stub.StreamObserver<proteus.proto.ProtoRuntime.ConnectionReply>) responseObserver);
          break;
        default:
